...
class DateTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->date7 = new Date('12,3,3');
    }
    public function testDiffDay()
    {
        $this->assertEquals($this->date->diffDay($this->date,$this->date5),430); 
    }
    public function testMinusDay()
    {
        $this->assertEquals($this->date->minusDay(10),"20,4,4"); 
    }
    ...
    {
        $this->assertEquals($this->date1->getDateOfWeek(),"Суббота"); 
    }
    public function testGetDateOfWeekTu()
    {
        $this->assertEquals($this->date2->getDateOfWeek(),"Понедельник"); 
    }
    public function testGetDateOfWeekWe()
    {
        $this->assertEquals($this->date3->getDateOfWeek(),"Вторник"); 
    }
    public function testGetDateOfWeekTh()
    {
        $this->assertEquals($this->date4->getDateOfWeek(),"Среда"); 
    }
    public function testGetDateOfWeekFr()
    {
        $this->assertEquals($this->date5->getDateOfWeek(),"Четверг"); 
    }
    public function testGetDateOfWeekSa()
    {
        $this->assertEquals($this->date6->getDateOfWeek(),"Четверг"); 
    }
    public function testGetDateOfWeekSu()
    {
        $this->assertEquals($this->date7->getDateOfWeek(),"Пятница"); 
    }
